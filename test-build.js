...
const files = execSync("find dist -type f | head -20")
  .toString()
  .split("\n")
  .filter(Boolean);
...
const hasCorrectPaths =
  indexHtml.includes(publicPath) || indexHtml.includes("_expo/static");
...
console.log("\n🧪 Next: Test Locally\n");
console.log(
  "Option A: Using http-server (recommended for GitHub Pages simulation)",
);
...
console.log(
  "  3. Site available at: https://hery21.github.io/crunch-cart-magic/",
);
console.log("");
console.log(
  "Check deployment status: https://github.com/hery21/crunch-cart-magic/actions",
);
console.log("\n" + "=".repeat(60) + "\n");
