...
const s = StyleSheet.create({
  ...
  backBtnText: { fontFamily: 'Poppins_400Regular', fontSize: 13, color: C.mutedFg },
  title: { fontFamily: 'Poppins_800ExtraBold', fontSize: 28, color: C.foreground, alignSelf: 'flex-start' },
  sub: { fontFamily: 'Poppins_400Regular', fontSize: 13, color: C.mutedFg, alignSelf: 'flex-start', marginBottom: 16 },
  pinInput: {
    width: '100%', borderWidth: 1, borderColor: C.border, borderRadius: R.xl,
    paddingVertical: 14, paddingHorizontal: 16, textAlign: 'center',
    fontFamily: 'Poppins_700Bold', fontSize: 24, letterSpacing: 12,
    color: C.foreground, backgroundColor: C.card, marginBottom: 12,
  },
  loginBtn: { width: '100%', backgroundColor: C.primary, borderRadius: R.xl, paddingVertical: 14, alignItems: 'center', marginBottom: 8 },
