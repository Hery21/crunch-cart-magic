                      ...
                      <View style={{ flex: 1 }}>
                        <View style={s.badges}>
                          ...
                          <View style={s.badgeAmber}>
                            <Text style={s.badgeAmberText}>
                              {SIZE_LABEL[item.size].toUpperCase()}
                            </Text>
                          </View>
                          <View
                            style={
                              item.priceTier === "kuantar"
                                ? s.badgeOrange
                                : s.badgeEmerald
                            }
                          >
                        ...
                        <Text style={s.addons}>
                          {[
                            item.filling && `Isi: ${item.filling}`,
                            item.celup && `Celup: ${item.celup}`,
                            item.tabur && `Tabur: ${item.tabur}`,
                          ]
                            .filter(Boolean)
                            .join(" • ") || "Tanpa tambahan"}
                        </Text>
